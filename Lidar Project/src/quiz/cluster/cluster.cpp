...
int main ()
{
	...
	// Create data
	std::vector<std::vector<float>> points = { {-6.2,7,1.2}, {-6.3,8.4,0.2}, {-5.2,7.1,2.2}, {-5.7,6.3,-1.2}, {7.2,6.1,-0.2}, {8.0,5.3,-2.2}, {7.2,7.1,4.2}, {0.2,-7.1,0.2}, {1.7,-6.9,0.5}, {-1.2,-7.2,1.2}, {2.2,-8.9,1.0} };
